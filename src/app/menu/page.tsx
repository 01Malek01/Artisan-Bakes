...
const pastries = [
    {
         ...
         title:"menu.pastry.croissant.title" ,
         description:"menu.pastry.croissant.description" 
    },
    {
         id:2,
         ...
         title:"menu.pastry.painAuChocolat.title" ,
         description:"menu.pastry.painAuChocolat.description" 
    },
    {
         id:3,
         ...
         title:"menu.pastry.almondCroissant.title" ,
         description:"menu.pastry.almondCroissant.description" 
    },
    {
         id:4,
         ...
         title:"menu.pastry.cinnamonRoll.title" ,
         description:"menu.pastry.cinnamonRoll.description" 
    },
]
...
const cakes = [
    {
        ...
        title:"menu.cake.chocolate.title" ,
        description:"menu.cake.chocolate.description" 
    },
    {
        id:2,
        ...
        title:"menu.cake.vanilla.title" ,
        description:"menu.cake.vanilla.description" 
    },
    {
        id:3,
        ...
        title:"menu.cake.redVelvet.title" ,
        description:"menu.cake.redVelvet.description" 
    },
    {
        id:4,
        ...
        title:"menu.cake.carrot.title" ,
        description:"menu.cake.carrot.description" 
    },
]
...
const cookies = [
    {
        ...
        title: "menu.cookie.chocolate.title",
        description: "menu.cookie.chocolate.description"
    },
    {
        id: 2,
        ...
        title: "menu.cookie.oatmeal.title",
        description: "menu.cookie.oatmeal.description"
    },
    {
        id: 3,
        ...
        title: "menu.cookie.peanutButter.title",
        description: "menu.cookie.peanutButter.description"
    },
    {
        id: 4,
        ...
        title: "menu.cookie.sugar.title",
        description: "menu.cookie.sugar.description"
    }
]
...
const services = [
    {
        id:1,
        title:"menu.service.catering.title",
        description:"menu.service.catering.description",
    ...
    {
        id:2,
        title:"menu.service.custom.title",
        description:"menu.service.custom.description",
  ...
  return (
    ...
    >
      <motion.div className="flex flex-col gap-2 mb-10" variants={headingVariants}>
        <h1 className="title text-2xl font-bold text-center lg:text-left" dir={isRTL ? 'rtl' : 'ltr'} style={{ textAlign: isRTL ? 'right' : 'left' }}>{t('menu.title')}</h1>
      ...
      <motion.div className="pastries-cards py-5" variants={headingVariants}>
        <h1 className="title text-center lg:text-left text-2xl font-bold" dir={isRTL ? 'rtl' : 'ltr'} style={{ textAlign: isRTL ? 'right' : 'left' }}>
          {t('menu.pastries')}
        </h1>
        <motion.div 
          ...
          {services.map(s => (
            <motion.div  key={s.id} variants={itemVariants} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
              ...
              direction='row'
                ...
                button={t('menu.button.learnMore')}
